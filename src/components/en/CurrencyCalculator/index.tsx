    ...
    <div className="mt-[150px]">
      ...
      <main className="relative mt-10 grid grid-cols-2 gap-5 p-5">
        ...
        <div className={`${element == false ? "hidden" : "grid"} `}>
          <div className="p-10">
            <div className="flex items-center justify-between p-5">
              <h1 className="text-[20px]">I have </h1>
              <p className="text-[18px] text-[#383838FF]">UZS</p>
            </div>
            {/* input */}
        ...
        <div className={`${element == true ? "hidden" : "grid"}`}>
          <div className="p-10">
            <div className="flex items-center justify-between p-5">
              <h1 className="text-[20px]">I will get</h1>
              <p className="text-[18px] text-[#383838FF]">USD</p>
            </div>
            {/* input */}
            <div className="mt-5 flex items-center justify-between">
              <input
        ...
        {/* 2 main */}
        <div
          className={`${element == false ? "hidden" : "grid"} bg-gray-100`}
        >
          <div className="p-10">
            <div className="flex items-center justify-between p-5">
              <h1 className="text-[20px]">I will get</h1>
        ...
        {/* 2-element */}
        <div
          className={`${element == true ? "hidden" : "grid"} bg-gray-100`}
        >
          <div className="p-10">
            <div className="flex items-center justify-between p-5">
              <h1 className="text-[20px]">I have </h1>
      ...
      <div className="relative">
        ...
        target="blank"
          ...
          className="absolute right-0 mt-20 text-[16px] font-[500] text-[#7000FFFF] underline decoration-slice"
        >
