  ...
  return (
    <>
      <div className="flex items-center justify-between">
        ...
        <select
          className="mx-10 w-[180px] cursor-pointer border-none py-5 text-2xl text-[#888888FF]"
          onChange={handleSelectChange}
        >
          <option
            value="O`zbek"
            className="cursor-pointer text-2xl text-[#888888FF]"
          >
            O`zbek
          </option>
          <option
        ...
        <Link href="uz/login" target="blank">
