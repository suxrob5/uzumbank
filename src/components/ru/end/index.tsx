...
const End = () => {
  ...
  return (
    <div className="mt-[100px]">
      <h1 className="text-2xl">Подпишитесь на наши обновления</h1>
      <div className="flex items-center justify-between p-10">
        ...
        >
          <input
            ...
            className="mx-3 w-[300px] rounded-lg bg-gray-100 px-5 py-5 text-2xl focus:outline-[#7000FFFF]"
          />
        ...
        <div className="relative">
          ...
          <a
            ...
            target="blank"
            className="absolute right-0 mt-3 text-xl text-[#7000FFFF]"
          >
            Telegram
          </a>
        </div>
