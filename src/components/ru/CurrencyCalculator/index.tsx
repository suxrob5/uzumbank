    ...
    <div className="mt-[150px]">
      <header>
        ...
        <p className="mt-8 text-[24px] font-[400] text-[#383838FF]">
          В Uzum Bank мы всегда используем выгодный курс
        </p>
      </header>
      <main className="relative mt-10 grid grid-cols-2 gap-5 p-5">
        ...
        <div className={`${element == false ? "hidden" : "grid"} `}>
          <div className="p-10">
            <div className="flex items-center justify-between p-5">
              <h1 className="text-[20px]">У меня есть</h1>
              <p className="text-[18px] text-[#383838FF]">Узбекский сум</p>
            </div>
            {/* input */}
            ...
            <div className="mt-10">
              <h1 className="text-xl ">
                Курс валют автоматически обновляется <br /> нажмите F5, если
                курс не обновился
              </h1>
            </div>
          </div>
        ...
        <div className={`${element == true ? "hidden" : "grid"}`}>
          <div className="p-10">
            <div className="flex items-center justify-between p-5">
              <h1 className="text-[20px]">Я получу</h1>
              <p className="text-[18px] text-[#383838FF]">Доллар США</p>
            </div>
            {/* input */}
            <div className="mt-5 flex items-center justify-between">
              <input
